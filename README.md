...
- 从3998版本开始，ImGUI被Qt/Compose UI取代。对！使用新版界面而舍弃旧版界面的ImGUI已经似了，另外之前所有的语言翻译全部移除，默认只有英文，只保留存档对话框的翻译，如果不适应新版本的UI可以使用3996以及之前的旧版本Vita3K，目前新版本的Vita3K UI存在一些设置问题的bug。
