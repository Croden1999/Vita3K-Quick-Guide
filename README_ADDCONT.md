...
### Android
安卓7至安卓10的data文件夹不受任何权限限制，将下载的dlc压缩包解压覆盖至`/storage/emulated/0/Android/data/org.vita3k.emulator/files/vita/ux0/addcont/[标题ID]`文件夹内，可在Vita3K内容管理检查DLC是否放置正确。

安卓11+由于存储策略限制无法直接导入文件至data文件夹，仅能使用PC传输（除非使用mt管理器等软件对data文件夹授权）。将下载的dlc压缩包解压覆盖至`/storage/emulated/0/Android/data/org.vita3k.emulator/files/vita/ux0/addcont/[标题ID]`文件夹内，可在Vita3K内容管理检查DLC是否放置正确。
