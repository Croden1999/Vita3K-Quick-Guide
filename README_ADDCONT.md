...
### Android
例如他人提供的readdcont/其他的解密DLC(s)就可使用，将下载的dlc解压覆盖在`/storage/emulated/0/Android/data/org.vita3k.emulator/files/vita/ux0/addcont/[标题ID]`文件夹内，可在Vita3K内容管理检查DLC是否放置正确。
